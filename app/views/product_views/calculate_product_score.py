...
def calculate_product_score(product_id, minimum_reviews=5):
    ...
    product.product_score = (
        (product.annotated_review_count * product.annotated_average_rating + minimum_reviews * global_average_rating)
        / denominator
    )
